  ...
  return (
    <>
      ...
      <div className="relative h-full sm:min-h-screen">
        <img className="h-screen w-full fixed" src={BROWSE_BG} alt="bg-img" />
        <div className="absolute flex top-28 left-0 right-0 flex-wrap justify-center gap-4 px-12">
          <div className="text-white h-72 w-3/4 rounded-xl bg-gradient-to-t from-yellow-700 shadow-lg sm:h-72 sm:w-64">
            <img
          ...
          <div className="text-white h-72 w-3/4 rounded-xl bg-gradient-to-t from-gray-500 shadow-lg sm:h-72 sm:w-64">
            <img
              className="rounded-t-xl h-32 w-full object-cover sm:h-40"
          ...
          <div className="text-white h-72 w-3/4 rounded-xl bg-gradient-to-t from-red-500 shadow-lg sm:h-72 sm:w-64">
            <img
              className="rounded-t-xl h-32 w-full object-cover sm:h-40"
          ...
          <div className="text-white h-72 w-3/4 rounded-xl bg-gradient-to-t from-teal-500 shadow-lg sm:h-72 sm:w-64">
            <img
              className="rounded-t-xl h-32 w-full object-cover sm:h-40"
